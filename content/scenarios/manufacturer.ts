...
const findings: Finding[] = [
  ...
  f('erp-shared-admin', 'erp',
    'Everyone in the office logs into the order system with the same administrator login',
  ...
  f('cnc-windows-xp', 'cnc',
    'Two of the big machines run on Windows XP computers',
  ...
  f('files-smbv1', 'fileserver',
    'The drawings server uses an old file-sharing method that ransomware was built to exploit',
  ...
  f('files-admin-daily', 'fileserver',
    'Dave uses the master login for everyday email and web browsing',
    'Domain admin account used as a daily driver',
    8.0, 0.3, 1, { compliance: true, tags: ['fileserver', 'access', 'password'] }),

  // ---- Company email ------------------------------------------------------
  f('email-mfa', 'email',
    "Anyone who guesses a password can read that person's email, because login has no second check",
  ...
  f('email-training', 'email',
    'Nobody has shown the staff what a fake purchase order email looks like',
    'No phishing awareness training on record',
    4.0, 0.4, 1, { compliance: true, tags: ['email', 'training'] }),

  // ---- Remote access ------------------------------------------------------
  f('remote-vpn-eol', 'remote',
    'The remote-access box is a model the maker no longer supports, and attackers are already using a hole in it',
  ...
  f('payroll-shared-pc', 'payroll',
    "Payroll runs on the receptionist's computer, between the visitor log and the radio",
  ...
  f('wifi-router-eol', 'wifi',
    'The internet router is a model its maker no longer supports, and attackers have a known way into it',
  ...
  f('cameras-default-password', 'cameras',
    'The security cameras still use the factory password, and anyone on the internet can watch them',
  ...
  f('web-cms', 'website',
    'The website runs an old version of its software, and attackers are hitting that version right now',
    ...
    effects: [
      {
        ...
        findings: [
          f('newcnc-modem', 'newcnc',
            'The new machine has its own cellular line for the vendor to dial in, and the line is live',
...
const headlines: Record<string, string> = {
  ...
  'cnc-usb-programs': "Operators load programs off take-home USB sticks",
  'files-everyone-full': "Anyone can delete any drawing",
  'files-smbv1': "Drawings server open to ransomware",
  ...
  'remote-vpn-eol': "Remote-access box unsupported and under attack",
  ...
  'wifi-router-eol': "Router unsupported, with a known way in",
  'wifi-guest-flat': "Guest Wi-Fi shares the order network",
  'cameras-default-password': "Cameras online with the factory password",
  'badges-old-pc': "Door badge PC years out of date",
  'web-cms': "Website runs a version attackers are hitting",
  'web-quote-uploads': "Customer drawings in a public folder",
  'newcnc-modem': "New machine's vendor line is live",
