...
const findings: Finding[] = [
  ...
  f('email-training', 'email',
    'Nobody has ever shown the staff what a fake supplier invoice looks like',
    'No phishing awareness training on record',
    4.0, 0.4, 1, { compliance: true, tags: ['email', 'training'] }),
  f('email-forwarding', 'email',
    'The billing inbox forwards a copy of every email to an outside address nobody recognises',
  ...
  f('web-booking-plugin', 'website',
    'The booking tool on your website has a hole that attackers are using on sites like yours this week',
  ...
  f('pay-shared-pc', 'payments',
    'Staff do the billing on the same computer they use for personal browsing at lunch',
  ...
  f('remote-rdp', 'remote',
    "Marcus's way in from home is open to the whole internet, and criminals scan for exactly that",
...
const headlines: Record<string, string> = {
  ...
  'frontdesk-browser': "Front desk browser skipped a fix criminals use",
  'frontdesk-sticky-notes': "Passwords on sticky notes at reception",
  'frontdesk-no-lock': "Front desk screens never lock",
  'web-booking-plugin': "Booking tool being broken into this week",
  ...
  'pay-shared-pc': "Billing runs on a PC used for lunch browsing",
