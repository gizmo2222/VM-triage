...
const events: GameEvent[] = [
  ...
  {
    id: 'slow-month',
    plainTitle: 'A slow month',
    techTitle: 'Budget cut',
    plainBody: 'Two hygienists out and a big insurer paying late. You can only afford three fixes this month.',
    techBody: 'Remediation capacity reduced by 2 this round.',
    effects: [{ kind: 'capacityDelta', delta: -2 }],
  },
  {
    id: 'quiet-month',
    plainTitle: 'A quiet month',
  ...
  },
  {
    ...
    plainBody:
      'Your insurer sent a forty-question security form with the renewal. It is due at the end of the month. Anything on the list they ask about that is still open will count against you.',
