...
export const copy = {
  ...
  intro: {
    ...
    howItWorks: [
      'Each month you get a short list of fixes you can afford.',
      'Everything you leave open is a door. Some doors get kicked in.',
      'At the end, see how your year went, and how it would have gone with a different order.',
    ],
  },
  ...
  round: {
    ...
    instinctsHeading: 'Or go with an instinct',
    instinctsHint: 'Picks for you. You can still change anything.',
    clearPicks: 'Clear picks',
    listHeading: 'The list',
    listHint: (count: number) => `${count} open problems. Tap to pick.`,
    ...
    commitHint: 'Then see what happens to the rest.',
